...
#import "RegistWeightViewController.h"
#import "ZHRulerView.h"
#import <MBProgressHUD.h>
#import "UserManager.h"

static CGFloat const rulerMultiple=10;
@interface RegistWeightViewController ()<ZHRulerViewDelegate>
...
@implementation RegistWeightViewController
{
    CGFloat value;
}
...
- (void)viewDidLoad {
    ...
    [self.rulerview setWithMixNuber:40 maxNuber:150 showType:rulerViewshowHorizontalType rulerMultiple:rulerMultiple];
    value = self.rulerview.defaultVaule=60;
    _valueLable.text=[NSString stringWithFormat:@"%dkg",(int)60];
...
-(IBAction)nextClicked:(id)sender
{
    ...
    [UserManager sharedManager].registerModel.weight = [NSString stringWithFormat:@"%d",(int)value];
...
-(void)getRulerValue:(CGFloat)rulerValue withScrollRulerView:(ZHRulerView *)rulerView{
    _valueLable.text=[NSString stringWithFormat:@"%dkg",(int)rulerValue];
    value = rulerValue;
